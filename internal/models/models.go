...
type Chart struct {
	...
	User        User
	Name        string
	Type        string // bar, line, pie, scatter, radar, heatmap, gauge, funnel, area, 3d-bar, 3d-scatter, 3d-surface, 3d-bubble, treemap, sunburst, tree, boxplot, candlestick, wordcloud
